...
const es: Record<LocaleKey, string> = {
  'page.title': 'Selph\'Yoto - Plantilla de impresión MYO',
  ...
  'toolbar.sizing': 'TAMAÑO',
  'toolbar.fitCard': 'Ajustar a tarjeta',
  'toolbar.fillCard': 'Rellenar tarjeta',
