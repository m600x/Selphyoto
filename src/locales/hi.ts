...
const hi: Record<LocaleKey, string> = {
  ...
  'toolbar.sizing': 'आकार',
  'toolbar.fitCard': 'कार्ड में फ़िट करें',
  'toolbar.fillCard': 'कार्ड भरें',
  ...
  'toolbar.adjust': 'समायोजन',
  'filter.exposure': 'एक्सपोज़र',
  'filter.contrast': 'कंट्रास्ट',
  'filter.clarity': 'स्पष्टता',
